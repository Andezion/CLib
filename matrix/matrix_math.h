...
inline struct int_matrix *div_int_matrices(size_t n, ...);
...
inline struct float_matrix *mul_float_matrices(size_t n, ...);
inline struct float_matrix *div_float_matrices(size_t n, ...);
