...
int main()
{
    ...
    struct int_matrix *matrix_result_int = sub_int_matrices(2, 5, 5, matrix_int_one, matrix_int_two);
    ...
    struct float_matrix *matrix_result_float = sub_float_matrices(2, 5, 5, matrix_float_one, matrix_float_two);
