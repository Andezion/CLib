...
int main()
{
    ...
    struct int_matrix *matrix_result_int = div_int_matrices(2, matrix_int_one, matrix_int_two);
    ...
    struct float_matrix *matrix_result_float = div_float_matrices(2, matrix_float_one, matrix_float_two);
