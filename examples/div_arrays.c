...
int main()
{
    ...
    struct int_array *array_result_int = div_int_arrays(2, 5, array_int_one, array_int_two);
    ...
    struct float_array *array_result_float = div_float_arrays(2, 3, array_float_one, array_float_two);
