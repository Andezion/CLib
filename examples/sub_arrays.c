...
int main(void)
{
    ...
    struct int_array *array_result_int = sub_int_arrays(2, 5, array_int_one, array_int_two);
    ...
    struct int_array *array_result_int_error = sub_int_arrays(2, 5, error_numbers_array_int_one, error_numbers_array_int_two);
    ...
    struct float_array *array_result_float = sub_float_arrays(2, 5, array_float_one, array_float_two);
